  ...
  return (
    <div className="sticky top-[15vh] flex items-center justify-center h-[70vh]">
      <motion.div
        ...
        className={`relative w-full max-w-[1000px] h-[500px] overflow-hidden rounded-[3rem] border border-white/10 ${item.color} p-12 md:p-16 flex flex-col justify-between shadow-2xl backdrop-blur-3xl`}
      >
        <div className="flex flex-col md:flex-row justify-between gap-10">
          <div className="space-y-4">
            ...
            <h4 className="text-4xl md:text-5xl font-black text-white tracking-tighter f-syne italic leading-none">
              {item.role}
            </h4>
          ...
          <div className="text-right space-y-2">
            <span className="text-xs font-mono text-zinc-500 tracking-[0.3em] uppercase italic block">{item.period}</span>
            <span className="text-white font-bold f-syne italic text-2xl md:text-3xl whitespace-nowrap">{item.duration}</span>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-end">
           <div className="md:col-span-12">
              <p className="text-zinc-400 text-lg md:text-xl leading-relaxed italic font-light">
                {item.details}
              </p>
           </div>
        </div>
